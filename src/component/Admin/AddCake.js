...
function AddCake(props) {
    ...
    const fileUpload = (event) => {
        ...
        const addToCartApiUrl = process.env.REACT_APP_API_BASE_URL + "/ upload"
            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-12">
                        <div className="box">
                            <h1>Adding New Cake</h1>
                            <hr />
                            <form method="post">

                                <div className="form-group">
                                    <label for="name">Cake Name</label>
                                    <input type="text" onChange={nameHandler} className="form-control" />
                                    <p className="text-danger">{error.cakeName ? (error.cakeName) : ''}</p>
                                </div>
                                <div className="form-group">
                                    <label for="email">Cake Description</label>
                                    <input id="description" type="text" onChange={descriptionHandler} className="form-control" />
                                    <p className="text-danger">{error.description ? (error.description) : ''}</p>
                                </div>
                                <div className="form-group">
                                    <label for="password">Cake Price</label>
                                    <input id="price" type="text" onChange={priceHandler} className="form-control" />
                                    <p className="text-danger">{error.price ? (error.price) : ''}</p>
                                </div>
                                <div className="form-group">
                                    <label for="password">Cake Weight</label>
                                    <input id="weight" type="text" onChange={weightHandler} className="form-control" />
                                    <p className="text-danger">{error.weight ? (error.weight) : ''}</p>
                                </div>
                                <div className="form-group">
                                    <label for="password">Cake Type</label>
                                    <select className="form-control" onChange={cakeTypeHandler}>
                                        <option value="">--Select--</option>
                                        <option value="Special">Special</option>
                                        <option value="General">General</option>
                                        <option value="birthday">Birthday</option>
                                    </select>
                                    <p className="text-danger">{error.cakeType ? (error.cakeType) : ''}</p>
                                </div>
                                <div className="form-group">
                                    <label for="password">Cake Flavour</label>
                                    <select className="form-control" onChange={flavourHandler}>
                                        <option value="">--Select--</option>
                                        <option value="Chocolate">Chocolate</option>
                                        <option value="Vanila">Vanila</option>
                                        <option value="rasmalai">Rasmalai</option>
                                    </select>
                                    <p className="text-danger">{error.flavour ? (error.flavour) : ''}</p>
                                </div>
                                ...
                                <div className="form-group">
                                    <div className="form-group">
                                        <div className="checkbox">
                                            <label>
                                                <input onChange={eggLessHandler} type="checkbox" value={eggless} /><span className="colour white"></span> Eggless
                                             </label>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div className="form-group">
                                            <div className="row">
                                                <div className="col-lg-8">
                                                    ...
                                                    />
                                                    <p className="text-danger">{error.inputList ? (error.inputList) : ''}</p>
                                                </div>
                                ...
                                <div className="form-group">
                                    ...
                                    <input type="file" onChange={fileUpload} accept="image/png, image/gif, image/jpeg, image/jpg" enctype="multipart/form-data" />
                                    <p className="text-danger">{error.uploadCakeImage ? (error.uploadCakeImage) : ''}</p>
                                </div>
